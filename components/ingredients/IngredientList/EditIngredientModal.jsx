...
import styles from "./EditIngredientModal.module.css";

export default function EditIngredientModal({ onCloseUpdate, onIngredientUpdated }) {
    ...
    <label>
      ...
      Litre
          ...
          <div className={styles.modalActions}>
            ...
            <button type="button" onClick={onCloseUpdate}>Annuler</button>
          </div>
        </form>
      </div>
    </div>
